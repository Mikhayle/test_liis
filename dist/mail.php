...
$mail->addAddress('alexmiko1988@gmail.com');     // Кому будет уходить письмо 
$mail->addAddress('hr@liis.su');               // Name is optional
...
$mail->Body    = '' .$name . ' оставил заявку, его телефон ' .$phone. '<br>Электронная почта: ' .$email;
$mail->AltBody = '';
